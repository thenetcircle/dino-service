...
from dinofw.rest.models import SendMessageQuery, HistoryQuery, Message, EditMessageQuery, AdminQuery, MessageQuery
...
class MessageResource(BaseResource):
    ...
    async def update_messages_for_user(self, group_id: str, user_id: int, query: MessageQuery) -> List[Message]:
        pass

    async def delete_messages_for_user_in_group(self, group_id: str, user_id: int, query: AdminQuery):
        pass
