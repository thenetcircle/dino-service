...
class TestLastReadTime(BaseServerRestApi):
    ...
    def test_last_read_api_one_user(self):
        ...
        last_read_a = self.get_last_read_for_one_user(message["group_id"], BaseTest.USER_ID)
        last_read_b = self.get_last_read_for_one_user(message["group_id"], BaseTest.OTHER_USER_ID)
