...
class TestGroupResource(BaseTest):
    ...
    async def test_leave_group(self):
        ...
        self.group.leave_group(BaseTest.GROUP_ID, BaseTest.USER_ID, GroupTypes.GROUP, CreateActionLogQuery(), None)  # noqa
        ...
        # leave the group
        self.group.leave_group(group.group_id, BaseTest.USER_ID, GroupTypes.GROUP, CreateActionLogQuery(), None)  # noqa
